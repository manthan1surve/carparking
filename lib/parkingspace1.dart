    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Level 1", style: TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
        ...
        child: Column(
          children: [
            ...
            if (parkingSpace == 1) ElevatedButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => ReservePage(slotKey: spotId, slotName: spotName)));
              },
